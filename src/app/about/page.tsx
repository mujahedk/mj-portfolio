      ...
      <div className="max-w-5xl mx-auto">
        ...
        <section className="mb-20">
          ...
          <div className="text-center">
            <p className="text-lg text-[var(--muted)] max-w-3xl mx-auto mb-8">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <a
                ...
                className="rounded-xl border border-[var(--border)] px-3 py-1.5 text-sm text-[var(--text)] hover:bg-[var(--surface-hover)] transition-colors duration-200"
              >
                Instagram (Wonder)
              </a>
              <a
        ...
        <section className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/projects"
              className="inline-flex items-center px-6 py-3 text-base font-medium text-[var(--text)] bg-[var(--surface)] border border-[var(--border)] hover:bg-[var(--surface-hover)] rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-[var(--primary)] focus:ring-offset-2"
            >
              View My Work
            </Link>
          </div>
