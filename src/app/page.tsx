    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-[var(--text)] mb-6">
            Hi, I&apos;m <span className="text-[var(--primary)]">MJ</span>
          </h1>
          <p className="text-xl sm:text-2xl text-[var(--muted)] mb-8 max-w-3xl mx-auto">
      ...
      <section className="mx-auto max-w-6xl py-10">
        <h2 className="text-center text-3xl font-semibold text-[var(--text)]">What I Do</h2>
        <p className="mt-2 text-center text-[var(--muted)]">Building, researching, and sharing knowledge.</p>
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-3 mt-8">
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-[var(--text)] mb-2">Development</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-[var(--text)] mb-2">Research</h3>
            <p className="text-[var(--muted)]">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-[var(--text)] mb-2">Writeups</h3>
            <p className="text-[var(--muted)]">
      ...
      <section className="mx-auto max-w-6xl py-10">
        <h2 className="text-center text-3xl font-semibold text-[var(--text)]">Featured Projects</h2>
        <p className="mt-2 text-center text-[var(--muted)]">A few things I&apos;m building and polishing. Use the arrows to explore more.</p>
        ...
        <div className="text-center mt-12">
            <Link
              href="/projects"
              className="inline-flex items-center px-6 py-3 text-base font-medium text-[var(--text)] bg-[var(--surface)] border border-[var(--border)] rounded-lg hover:bg-[var(--surface-hover)] transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-[var(--primary)] focus:ring-offset-2"
            >
              View All Projects
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Link
                      ...
                      className="text-[var(--link)] hover:text-[var(--link-hover)] text-sm font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-[var(--primary)] focus:ring-offset-2 rounded"
                    >
                      Read More →
                    </Link>
                  </div>
      ...
      <section className="mx-auto max-w-4xl py-14 text-center">
        <h2 className="text-3xl font-semibold text-[var(--text)]">Let&apos;s work together</h2>
        <p className="mt-2 text-[var(--muted)]">Have a project or question? Reach out anytime.</p>
