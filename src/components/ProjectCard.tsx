...
export default function ProjectCard({ title, tags, summary, image, repo, liveUrl }: ProjectCardProps) {
  return (
        ...
        <div className="flex gap-2">
          {liveUrl ? (
            <Link
              ...
              className="flex-1 inline-flex items-center justify-center rounded-xl px-3 py-2 text-sm font-medium text-white bg-[var(--primary)] hover:bg-[var(--primary-hover)] shadow-sm focus:outline-none focus:ring-2 focus:ring-[var(--primary)] focus:ring-offset-2 transition-colors duration-200"
            >
